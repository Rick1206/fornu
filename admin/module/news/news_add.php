...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    优路新闻&gt;&gt;<a href="news_list.php" id="module_link">新闻列表</a>&gt;&gt;添加新闻</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>
        ...
        <tr>
         ...
         <!-- <tr>
          ...
          <php
			...
			$oFCKeditor->editor("description_en");
          >          </td>
        </tr>-->
          <tr>
          ...
          <?php
            ...
            //$oFCKeditor->Height	= 150 ;
			$oFCKeditor->editor("description_cn");
          ?> 
          </td>
        </tr>
         <tr>
...
<?php
	...
	$back_data = $db->query("INSERT INTO ".$ros->table('news')." ( title_en, intro_en, title_cn, intro_cn, description_en, description_cn, dateline, photo, image, orderby) VALUES ('".$param['title_en']."','".$param['intro_en']."', '".$param['title_cn']."', '".$param['intro_cn']."','".htmlspecialchars($param['description_en'])."', '".htmlspecialchars($param['description_cn'])."', '".$param['add_time']."','".$pic."','".$pic2."','".$param['orderby']."')");
		...
		$back_data = $db->query("INSERT INTO ".$ros->table('news')." (title_cn, intro_cn, description_cn, dateline , orderby) VALUES ('".$param['title_cn']."', '".$param['intro_cn']."','".htmlspecialchars($param['description_cn'])."', '".$param['add_time']."','".$param['orderby']."')");
			if($back_data)
			{
				show_msg('添加成功','news_add.php');  
			}
