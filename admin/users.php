...
<!-- left menu start-->
<div id="contant_left">
	<div id="left_title">用户管理</div>
    <?php
    if( @in_array('6',$a_right))
	{
	?>
    <div class="left_list" id="0"><img src="images/dir.gif" />用户管理</div>
...
<div id="contant_right">
    <div id="right_mark">
            ...
            <iframe src="module/users/users.php" width="760" height="470" allowtransparency="true" frameborder="0" scrolling="auto" marginwidth="0" marginheight="0" name="a0"></iframe>
            </div>
       		<!--news list end-->
            <!--event list start-->
           <!-- <div class="include_module">
