...
function submitForm(){
	$.ajax({
		type:'POST',
		url:'reg_submit.php',
		data:{mobile:v("#mobile"),nickname:v("#nickname"),email:v("#email"),password:v("#password"),mumname:v("#mumname"),
				area:v("#area"),address:v("#address"),phone:v("#phone1")+v("#phone2"),zipcode:v("#zipcode"),
				now:v("#now"),maga:v("#maga"),activity:v("#activity"),contact:v("#contact")
		},
		success:function(e){
				var e = 1;
				if(e=="1")
